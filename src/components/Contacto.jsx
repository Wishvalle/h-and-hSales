...
const MailIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-3 h-6 w-6 text-blue-600"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
);

const MapPinIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-3 h-6 w-6 text-blue-600"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
);
...
export const Contacto = () => (
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-white">Contáctenos</h2>
        <p className="text-slate-400 mt-2">Estamos listos para atenderle. ¡Hablemos de su próximo bus!</p>
      </div>
      <div className="max-w-4xl mx-auto bg-slate-900 p-8 rounded-xl shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-lg">
            <div className="space-y-6">
                <a href="tel:+50622223333" className="flex items-center text-slate-200 hover:text-blue-500 transition-colors">
                    <PhoneIcon />
                    <span>(+506) 2222-3333</span>
                </a>
                <a href="mailto:ventasbuseshh@gmail.com" className="flex items-center text-slate-200 hover:text-blue-500 transition-colors">
                    <MailIcon />
            ...
            <div className="flex flex-col justify-center">
                <h3 className="text-xl font-bold text-white mb-4">Síguenos en nuestras redes sociales</h3>
